...
//Must have a function named intersection()
  ...
  it("intersection() function must return the element that is present in all of the arrays of the (array)", function(){
    var array = ( [1, 2, 3], [5, 2, 1, 4], [2, 1] );
    var test_array1 = arrayfun.intersection( array );
    expect( test_array1 ).toBe( [1, 2] );
